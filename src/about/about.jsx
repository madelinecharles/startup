...
export default function About() {
  const [quote, setQuote] = useState({
    q: "Water is the driving force of all nature.",
    a: "Leonardo da Vinci",
  });
  ...
  useEffect(() => {
    ...
    const mockQuotes = [
      ...
      {
        q: "Thousands have lived without love, not one without water.",
        a: "W.H. Auden",
      },
      {
        q: "Pure water is the world's first and foremost medicine.",
        a: "Slovakian Proverb",
      },
      {
        q: "In one drop of water are found all the secrets of all the oceans.",
        a: "Kahlil Gibran",
      },
    ];
  ...
  return (
    ...
    >
      <div>
        ...
        <p
          style={{ color: "#1565c0", maxWidth: "500px", margin: "0 auto 1rem" }}
        >
          Drinkly is a gamified water intake tracker that turns hydration into a
          daily streak game. Log water with a single tap and watch your virtual
          tree grow with animations as you hit your personalized goals. Earn
          fruit rewards, unlock new tree species, and compete with friends on a
        ...
        <div
          className="features-grid text-start"
        ...
        <div
          className="quote-box text-start mx-auto mt-4 mb-4"
